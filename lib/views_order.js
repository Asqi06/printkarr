...
export function walletPage(user, wallet, tx, pricing, opts = {}) {
  ...
  return layout({
    ...
    ${opts.cash != null ? `<a class="card promo rv" href="/customer/referrals" style="text-decoration:none;display:block;margin-top:12px"><p class="eyebrow">Cash earnings · separate, withdrawable</p><div class="stat"><div class="v">${rs(opts.cash)}<em> cash</em></div><div class="k">Refer friends, earn real UPI money →</div></div></a>` : ''}
