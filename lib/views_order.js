  ...
  return layout({
    ...
    <form method="POST" action="/customer/orders/new/confirm" style="margin-top:18px">
      ...
      <div class="card rv">
        ...
        <div class="field" style="margin-top:8px"><input name="range" placeholder="All ${draft.pages} pages — or e.g. 1-12, 15-20"></div>
        <div class="grid c2">
        ...
        <div class="grid c2">
          <div class="field"><label for="copies">Copies</label><input id="copies" name="copies" type="number" value="1" min="1" max="200"></div>
...
export function profilePage(user, addresses, notes) {
  ...
  return layout({
    ...
    <div class="grid c2" style="margin-top:18px">
      <div class="card rv"><p class="eyebrow">Details</p>
        ...
        <div class="sumrow"><span>Student rate</span><span>${user.student ? 'ON · ₹1.75 B&W' : 'Off'}</span></div>
      </div>
      <div class="card rv" id="addresses"><p class="eyebrow">Saved addresses</p><div style="margin-top:8px">${addr}</div>
        <details style="margin-top:10px"><summary class="rowlink">+ Add address</summary>
          <form method="POST" action="/customer/addresses/add" style="margin-top:10px">
            <div class="grid c2"><div class="field"><label>Label</label><select name="label"><option>Home</option><option>Hostel</option><option>College</option><option>PG</option><option>Office</option></select></div>
            <div class="field"><label>Phone</label><input name="phone" required></div></div>
            <div class="field"><label>Address</label><input name="address" required></div>
            <div class="grid c3"><div class="field"><label>Area</label><select name="area"><option>Classroom pickup</option><option>Sarigam</option><option>Vapi</option><option>Bhilad</option></select></div>
            <div class="field"><label>Landmark</label><input name="landmark"></div>
            <div class="field"><label>PIN</label><input name="pin" required></div></div>
