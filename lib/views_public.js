...
export function landing({ pricing }) {
  ...
  return shell({ active: '/', title: 'Print now. Anywhere in Vapi.', body: `
    <div class="marketing-wrap home-v2">
      ...
      <div class="home-ticker" aria-label="PrintKarr services"><span>OPEN 24 / 7</span><span>VAPI DELIVERY</span><span>KIOSK PICKUP</span><span>INDIA-WIDE SHIPPING</span></div>
      ...
      <section class="home-route"><div class="home-route-heading"><p class="eyebrow">03 / CHOOSE YOUR ROUTE</p><h2>Printed here.<br><em>Where you need it.</em></h2></div><div class="home-route-list">
        ...
        <a href="/order"><span class="route-index">02</span><span><b>Delivered across Vapi</b><small>24/7, including midnight orders. Fees shown before payment.</small></span><span aria-hidden="true">↗</span></a>
