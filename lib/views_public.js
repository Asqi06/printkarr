  ...
  return shell({ active: '/', title: 'Print now. Anywhere in Vapi.', body: `
    <div class="marketing-wrap home-v2">
      ...
      <section class="home-section"><div class="home-section-head"><p class="eyebrow">SEMESTER PACKS · SAVE VS MARKET</p><h2>College bundle.<br><em>Pay ₹199, print all term.</em></h2><p class="muted" style="margin-top:8px;max-width:56ch">Secure any pack with ₹199, pay the rest in installments — quota and balance live on your dashboard.</p></div><div class="home-use-grid">
        <a class="home-use home-use-student rv" href="/login"><span class="home-use-num">₹329 · SAVE ₹141</span><strong>130 + 10<br>sides + files</strong><span class="home-use-detail">2 free files · market ₹470</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-everyday rv" href="/login"><span class="home-use-num">₹499 · SAVE ₹301</span><strong>250 + 15<br>sides + files</strong><span class="home-use-detail">4 free files · market ₹800</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-business rv" href="/login"><span class="home-use-num">₹725 · SAVE ₹275</span><strong>400 + 20<br>sides + files</strong><span class="home-use-detail">5 free files · market ₹1000</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
