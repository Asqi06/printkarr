...
function shell({ title, body, desc, active, extraHead, stickyCta }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export function landing({ pricing, maxMb }) {
  ...
  return shell({ active: '/', stickyCta: true, title: 'Need it on paper?', desc: 'Upload a PDF and print from your phone. Kiosk pickup or local delivery around Vapi. See the full price before payment.', body: `
