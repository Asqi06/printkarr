...
<div class="sticky-cta"><a href="/order">Upload PDF &amp; Print →</a></div>
${pkPublicFooter()}
</div>
...
export function landing({ pricing, maxMb }) {
  ...
  const mb = maxMb || 20;
  return shell({ active: '/', title: 'Print anything. From your phone.', body: `
    <div class="marketing-wrap home-v2">
      <section class="studio-hero">
        <div class="hero-copy">
          <p class="eyebrow"><span class="status-dot"></span> CHALA, VAPI · GUJARAT 396191</p>
          <h1>Print anything.<br><em>From your phone.</em></h1>
          <p class="hero-description">Upload your PDF → Choose print settings → Pay online → <b>Collect at a kiosk or get it delivered.</b></p>
          <div class="hero-actions"><a class="btn loud big" href="/order">Upload PDF &amp; See Price <span aria-hidden="true">→</span></a><a class="text-link" href="/how-it-works">How it works →</a></div>
          <div class="hero-proof"><span><b>${rs(minRate)}</b> / page onwards</span><span>Full price before payment</span><span>Files auto-deleted</span></div>
        </div>
        <form class="hero-upload rv" method="POST" action="/order/upload" enctype="multipart/form-data">
          <label class="drop" for="hero-doc"><span class="drop-arrow">↑</span><b>Drop your PDF here</b><span class="muted">or choose from your device · PDF up to ${mb} MB</span></label>
          <input id="hero-doc" name="doc" type="file" accept="application/pdf,.pdf" required class="file-input">
          <button class="btn loud big" type="submit" style="width:100%"><span>Upload PDF &amp; See Price →</span></button>
          <p class="field-hint" style="text-align:center">🔒 Your document stays private — automatically deleted after printing.</p>
        </form>
        <script>document.getElementById('hero-doc').addEventListener('change',function(e){var f=e.target.files[0];if(f)e.target.form.submit();});</script>
      </section>
      <div class="home-ticker" aria-label="PrintKarr services"><span>OPEN 24 / 7</span><span>VAPI + DAMAN DELIVERY</span><span>KIOSK PICKUP</span><span>NO APP NEEDED</span></div>
      ...
      <section class="home-section" id="pricing"><div class="home-section-head"><p class="eyebrow">02 / HONEST PRICING</p><h2>See the full price<br><em>before you pay.</em></h2><p class="muted" style="margin-top:8px;max-width:56ch">Printing + delivery shown upfront on every order. No surprise fees, ever.</p></div>
      <div class="grid c3">
        <div class="card rv"><p class="eyebrow">Black &amp; white</p><div class="stat"><div class="v money">₹${pricing.bw}<em>/page</em></div><div class="k">Students ₹${pricing.studentBw}/page · A4</div></div></div>
        <div class="card rv"><p class="eyebrow">Colour</p><div class="stat"><div class="v money">₹${pricing.color}<em>/page</em></div><div class="k">Students ₹${pricing.studentColor}/page · A4</div></div></div>
        <div class="card rv" id="locations"><p class="eyebrow">Delivery or pickup</p><div class="stat"><div class="v money">FREE<em> pickup</em></div><div class="k">Delivery across Vapi from ₹10 · Sarigam · Bhilad · Daman</div></div></div>
      </div></section>
      <section class="home-section"><div class="home-section-head"><p class="eyebrow">03 / FROM FILE TO FINISHED</p><h2>Four moves. <em>Done.</em></h2></div><ol class="home-steps"><li><span>01</span><b>Scan or start online</b></li><li><span>02</span><b>Upload a PDF</b></li><li><span>03</span><b>Choose pages &amp; pay</b></li><li><span>04</span><b>Collect or get delivery</b></li></ol><a class="text-link" href="/how-it-works">See how it works →</a></section>
      <section class="home-section"><div class="home-section-head"><p class="eyebrow">SEMESTER PACKS · SAVE VS MARKET</p><h2>College bundle.<br><em>Pay ₹199, print all term.</em></h2><p class="muted" style="margin-top:8px;max-width:56ch">Secure any pack with ₹199, pay the rest in installments — quota and balance live on your dashboard.</p></div><div class="home-use-grid">
        <a class="home-use home-use-pack rv" href="/login"><span class="pack-badges"><span class="pack-save">SAVE ₹30</span></span><strong>₹329</strong><span class="home-use-num">130 B&W + 10 COLOR SIDES</span><span class="home-use-detail">2 free files · market ₹470</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-pack popular rv" href="/login"><span class="pack-badges"><span class="pack-save">SAVE ₹120</span><span class="pack-tag">MOST POPULAR</span></span><strong>₹499</strong><span class="home-use-num">250 B&W + 15 COLOR SIDES</span><span class="home-use-detail">4 free files · market ₹800</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-pack premium rv" href="/login"><span class="pack-badges"><span class="pack-save">SAVE ₹200+</span></span><strong>₹725</strong><span class="home-use-num">400 B&W + 20 COLOR SIDES</span><span class="home-use-detail">5 free files · market ₹1000</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
      </div><a class="text-link" href="/login">Secure a pack with ₹199 →</a></section>
      <section class="home-route" id="locations"><div class="home-route-heading"><p class="eyebrow">04 / CHOOSE YOUR ROUTE</p><h2>Printed here.<br><em>Where you need it.</em></h2></div><div class="home-route-list">
      ...
      <section class="home-section"><div class="home-section-head"><p class="eyebrow">REFER &amp; EARN · REAL CASH</p><h2>Make your friend print.<br><em>Make ₹20.</em></h2><p class="muted" style="margin-top:8px;max-width:56ch">They get ₹10 off their first ₹79+ order. When it is delivered, you earn ₹20 real cash via UPI — plus bonuses at 3, 5 and 10 friends.</p><div style="margin-top:16px"><a class="btn sun big" href="/login"><span>Get my referral code →</span></a></div></div></section>
      <section class="home-section" id="faq"><div class="home-section-head"><p class="eyebrow">QUESTIONS, ANSWERED</p><h2>Fair <em>questions.</em></h2></div>
      <div class="faq">
        <details class="rv"><summary>What will my print cost?</summary><p>Exactly what you see before paying: pages × rate plus delivery (pickup is always free). B&amp;W from ₹${pricing.bw}/page, colour from ₹${pricing.color}/page.</p></details>
        <details class="rv"><summary>Is my document safe?</summary><p>Yes. Files are encrypted, never land on shop desktops, and are automatically deleted after printing.</p></details>
        <details class="rv"><summary>Do I need an account?</summary><p>No. Upload first — we only ask for an email to send your verification code and order updates.</p></details>
        <details class="rv"><summary>Where and when do you deliver?</summary><p>24/7 across Vapi, Sarigam, Bhilad and Daman, plus kiosk pickup. Prints outside the area can be shipped across India on request.</p></details>
        <details class="rv"><summary>How do I pay?</summary><p>UPI and cards via Razorpay, print wallet, or cash. Online payment is fastest.</p></details>
      </div></section>
      <section class="home-final rv"><h2 class="display">That PDF is not<br>going to print <em>itself.</em></h2><div style="margin-top:20px"><a class="btn loud big" href="/order"><span>Upload PDF &amp; See Price →</span></a></div><p class="muted" style="margin-top:12px;font-size:13px">Takes about 10 seconds. No account needed.</p></section>
      ${hostBannerHtml()}
    </div>` });
}
  ...
  return shell({
    ...
    <section class="pub-wrap">
      ...
      <form class="card rv" method="POST" action="/order/otp-request">
        ...
        <div class="field"><label for="ref">Friend's referral code (first order, optional)</label><input id="ref" name="referral" placeholder="K7Q2M4" maxlength="12" style="text-transform:uppercase" value="${esc(draft.contact?.referral || '')}"></div>
