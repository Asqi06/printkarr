...
<meta name="description" content="${esc(desc || "PrintKarr — 24/7 printing and delivery across Vapi, with print delivery available across India. Scan, upload, and choose how your pages reach you.")}">
...
function featuresHtml() {
  const cards = [
    ['01', 'Assignment due tonight?', 'In Vapi, print any time—yes, even after midnight—and get it delivered anywhere in the city.'],
    ['02', 'Exam, travel, or appointment?', 'Get an admit card, ticket, application, or ID copy on paper when a digital file is not enough.'],
    ['03', 'Print for your business, too.', 'Upload print-ready PDFs for business brochures, pamphlets, and customer handouts in colour or black and white.'],
    ['04', 'Stay in your neighbourhood.', 'Vapi print delivery runs 24/7 across the city, including late-night orders. Other local delivery options appear at checkout.'],
    ['05', 'Need prints across India?', 'PrintKarr also offers all-India print delivery. Delivery is ₹45–₹90 depending on distance.'],
    ['06', 'Your file stays yours.', 'Order from your own device and collect at the kiosk with an OTP. No USB hand-off at a shared counter.'],
  ];
    ...
    <div class="marketing-wrap">
      <section class="studio-hero">
        <div class="hero-copy">
          ...
          <p class="hero-description">Assignment due tonight? Need an admit card before the exam, or a brochure for your business? In Vapi, skip the late-night search for an open print shop: order 24/7 and get your prints delivered across the city—even at midnight. Pickup and all-India delivery are available too.</p>
          <div class="hero-actions"><a class="btn loud big" href="/order">Print what you need <span aria-hidden="true">↗</span></a><a class="text-link" href="/how-it-works">See pickup &amp; delivery options <span aria-hidden="true">→</span></a></div>
          <div class="hero-proof"><span><b>${rs(minRate)}</b> / page onwards</span><span>See your total before payment</span></div>
        </div>
      ...
      <div class="service-strip"><span>Print &amp; delivery · 24/7 across Vapi</span><span>Assignments &amp; admit cards</span><span>Business brochures &amp; pamphlets</span><span>All-India delivery · ₹45–₹90 by distance</span></div>
      ...
      <section class="pk-section"><div class="section-heading"><div><p class="eyebrow">03 / PICKUP OR DELIVERY</p><h2>Your document,<br>closer to you.</h2></div><p class="sub">Choose the route that suits your deadline and location.</p></div>
        <div class="grid c2">
          <article class="card ink rv"><p class="eyebrow" style="color:var(--blue-bright)">VAPI · 24 HOURS</p><h3 style="font-size:22px;margin-top:8px">Print now. Delivered across Vapi.</h3><p style="opacity:.78;font-size:14px;margin-top:8px">Place an order at any hour, including midnight. Our Vapi pilot delivers prints across the city, so a closed shop doesn’t have to stop your work. Any late-night or high-demand fee is included in your total before you pay.</p><a class="btn loud" href="/order" style="margin-top:18px"><span>Start a Vapi print order →</span></a></article>
          <article class="card rv"><p class="eyebrow">ACROSS INDIA</p><h3 style="font-size:22px;margin-top:8px">All-India print delivery</h3><p class="muted" style="font-size:14px;margin-top:8px">Need printed pages somewhere else in India? Request print delivery to your address. Delivery charges range from <b>₹45 to ₹90</b> based on distance.</p><a class="text-link" href="/contact">Ask about all-India delivery →</a></article>
        </div>
      </section>
      <section class="location-panel"><div><p class="eyebrow">VAPI PILOT / INDIA-WIDE AMBITION</p><h2>Vapi, meet<br>your nearby<br><em>print point.</em></h2><p>We’re piloting PrintKarr in Vapi with a simple ambition: make urgent printing easier to find, so people don’t have to hunt from shop to shop for an open counter. Print and delivery run 24/7 across Vapi—including midnight orders. As the pilot grows, we want to bring that convenience to communities across India.</p><a class="btn solid" href="/contact">Find or host a kiosk ↗</a></div><div class="location-stats"><span class="location-code">STARTING IN VAPI, GUJARAT</span><div><b data-tick="${pagesWeek}">${pagesWeek}</b><span>pages printed this week</span></div><div><b>${queueDepth}</b><span>jobs currently in the queue</span></div><p>Start local. Build for every community.</p></div></section>
      <section class="pk-section"><div class="section-heading"><div><p class="eyebrow">04 / PUT PRINTING WHERE PEOPLE NEED IT</p><h2>Where could a kiosk<br>make the day easier?</h2></div><p class="sub">A small print point can remove a long trip when a deadline is close.</p></div><div class="grid c3">
        <article class="card rv"><h3>Campuses &amp; hostels</h3><p class="muted" style="margin-top:8px;font-size:14px">Assignments, lecture notes, project submissions, and exam documents without a queue at the campus shop.</p></article>
        <article class="card rv"><h3>Libraries &amp; study spaces</h3><p class="muted" style="margin-top:8px;font-size:14px">Print reference pages, forms, and reading material where students already come to focus.</p></article>
        <article class="card rv"><h3>Offices &amp; small businesses</h3><p class="muted" style="margin-top:8px;font-size:14px">Print business brochures, pamphlets, and customer handouts, alongside routine office documents.</p></article>
        <article class="card rv"><h3>Transit &amp; travel hubs</h3><p class="muted" style="margin-top:8px;font-size:14px">Make a last-minute ticket, itinerary, or ID copy easier to collect on the way.</p></article>
        <article class="card rv"><h3>Malls &amp; community spaces</h3><p class="muted" style="margin-top:8px;font-size:14px">Offer nearby printing for forms, applications, and everyday paperwork.</p></article>
        <article class="card rv"><h3>Local print shops</h3><p class="muted" style="margin-top:8px;font-size:14px">Bring digital ordering and self-service into an existing print business.</p></article>
      </div><a class="text-link" href="/franchise" style="display:inline-block;margin-top:18px">Explore kiosk partnerships →</a></section>
      ${hostBannerHtml()}
      <section class="faq-section"><div><p class="eyebrow">BEFORE YOU HIT PRINT</p><h2>Good questions.<br>Simple answers.</h2></div><div><details><summary>Do I need to install an app?</summary><p>No. Open PrintKarr in your browser or scan a kiosk QR code to get started.</p></details><details><summary>Can I check the price before paying?</summary><p>Yes. Choose pages, copies, and print settings to see the total before confirming.</p></details><details><summary>Can I print late at night in Vapi?</summary><p>Yes. PrintKarr’s Vapi pilot takes print and delivery orders 24/7 across the city, including midnight.</p></details><details><summary>Can I get prints delivered elsewhere in India?</summary><p>Yes. All-India print delivery is available for ₹45–₹90 depending on distance. <a href="/contact">Request delivery details →</a></p></details><details><summary>What can I print?</summary><p>Upload a PDF for assignments, admit cards, tickets, forms, business brochures, pamphlets, and work documents. Choose black and white or colour, with single or double-sided printing.</p></details><details><summary>Need a hand with an order?</summary><p><a href="/contact">Contact the PrintKarr team</a> with your order number and we’ll help you out.</p></details></div></section>
    </div>` });
}

export function orderPage({ draft, pricing, error, maxMb, surcharges = {} }) {
  const d = draft || null;
  const cfg = JSON.stringify({ bw: pricing.bw, color: pricing.color, fees: pricing.delivery, freeAbove: pricing.freeAbove, lateNightFee: surcharges.lateNightFee || 0, surgeFee: surcharges.surgeFee || 0 });
  return shell({
    active: '/order',
    title: 'Print now',
    body: `
    <section class="pub-wrap">
      ...
      <form method="POST" action="/order/options">
        ...
        <div class="livetotal rv" id="liveTotal"><span>Live estimate · night and high-demand fees may apply</span><b>₹–</b></div>
        <p class="field-hint">This estimate refreshes to include time-window and queue fees before payment.</p>
      ...
      (function(){
        ...
        function upd(){
          ...
          if (sub2) sub2.textContent = ep + ' pages × ' + copies + ' · ' + (type === 'bw' ? 'B&W' : 'Color') + ' · delivery ₹' + del + (late ? ' · late-night delivery +₹' + late : '') + (surge ? ' · high-demand +₹' + surge : '');
        }
  ...
  return shell({
    ...
    body: pageWrap(`<div style="max-width:48rem;margin:0 auto">
      ...
      <div class="muted rv" style="margin-top:32px;display:flex;flex-direction:column;gap:16px;font-size:16px;line-height:1.7">
        <p>PrintKarr is building a self-service print network for the moments paper still matters: an assignment due tonight, an admit card before an exam, a ticket for the morning, or a business pamphlet needed for customers.</p>
        <p>We’re piloting in Vapi first, with print and delivery available 24/7 across the city—including midnight orders. Our goal is to make urgent printing easier to find, so people don’t have to chase an open shop for last-minute pages. From Vapi, we want to bring that convenience to communities across India through kiosks and print delivery.</p>
        <p>Students, residents, and businesses can upload a PDF, choose exact pages and print settings, then collect at a kiosk or get prints delivered. PrintKarr also handles business materials such as brochures and pamphlets, and all-India print delivery for ₹45–₹90 depending on distance.</p>
      </div>
