  ...
  return shell({ active: '/', title: 'Print anything. From your phone.', body: `
    <div class="marketing-wrap home-v2">
      ...
      <section class="home-section"><div class="home-section-head"><p class="eyebrow">SEMESTER PACKS · SAVE VS MARKET</p><h2>College bundle.<br><em>Pay ₹199, print all term.</em></h2><p class="muted" style="margin-top:8px;max-width:56ch">Secure any pack with ₹199, pay the rest in installments — quota and balance live on your dashboard.</p></div><div class="home-use-grid">
        <a class="home-use home-use-pack rv" href="/login"><span class="pack-save">SAVE ₹141</span><strong>₹329</strong><span class="home-use-num">130 B&W + 10 COLOR SIDES</span><span class="home-use-detail">2 free files · market ₹470</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-pack rv" href="/login"><span class="pack-save">SAVE ₹301</span><strong>₹499</strong><span class="home-use-num">250 B&W + 15 COLOR SIDES</span><span class="home-use-detail">4 free files · market ₹800</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
        <a class="home-use home-use-pack rv" href="/login"><span class="pack-save">SAVE ₹275</span><strong>₹725</strong><span class="home-use-num">400 B&W + 20 COLOR SIDES</span><span class="home-use-detail">5 free files · market ₹1000</span><span class="home-use-arrow" aria-hidden="true">↗</span></a>
