...
export function pkPublicFooter() {
  ...
  <div><a class="pk-logo" href="/"><span class="w">Print</span><span class="b">Karr</span></a>
    <p class="muted" style="margin-top:16px;max-width:24rem;font-size:14px;line-height:1.6">24/7 print delivery across Vapi and Daman. Selected colleges in Sarigam and Bhilad. Kiosks planned in Vapi.</p>
    </div>
  <div><h4>PrintKarr</h4><ul><li><a href="/printing-in-vapi">Printing in Vapi</a></li><li><a href="/how-it-works">How it works</a></li><li><a href="/about">Built in Vapi</a></li><li><a href="/blogs">Stories</a></li><li><a href="/contact">Contact</a></li></ul><h4 style="margin-top:24px">Partners</h4><ul><li><a href="/franchise">For colleges &amp; businesses</a></li><li><a href="/xerox">For Xerox shops</a></li></ul></div>
