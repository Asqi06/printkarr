// Use the verified live origin until a custom domain is connected.
export const SITE = new URL(process.env.PUBLIC_SITE_URL || 'https://printkarr.onrender.com').origin;
export const PAGES = {
